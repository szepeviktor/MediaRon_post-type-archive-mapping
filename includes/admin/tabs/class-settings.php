						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input id="ptam-disable-blocks" type="checkbox" value="on" name="options[disable_blocks]" <?php checked( 'off', $options['disable_blocks'] ); ?> /> <label for="ptam-disable-blocks"><?php esc_html_e( 'Disable All Blocks', 'post-type-archive-mapping' ); ?></label>
